        ...
        <div class="chat-content" id="chatContent">
            <div class="chat-intro">
                <div class="pengrimi-avatar">
                    <img src="/images/character.png" alt="펭리미" style="width: 100%; height: 100%; object-fit: contain; transform: scaleX(-1);">
                </div>
            ...
            <!-- DB에서 불러온 메시지 출력 (현재는 주석 처리) -->
            <%-- 
            <div class="chat-messages-area">
                <c:forEach var="msg" items="${messages}">
                    <div class="message-bubble ${msg.chatter}">
                        ${msg.chatContent}
                    </div>
                </c:forEach>
            </div>
